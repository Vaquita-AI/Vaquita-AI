...
## Projects
- **Computer Vision**:
  - [Weird Stuff In Traffic](https://github.com/ToCans/Weird-Stuff-In-Traffic): Developed a gamified web application to enhance object detection models for autonomous driving. Users generate unusual traffic scenes via text prompts, and an AI (fine-tuned YOLO11n and Detectron2) attempts to detect anomalies. The system rewards users for exposing AI limitations, providing a unique human-in-the-loop approach to data collection and model improvement.
